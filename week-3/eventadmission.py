...
if is_military == "yes" and age >= 65:
    price = base_price * 0.85          #15% combined discount ($34)
    print(f"Thank you for your service! Senior Military Discount applied: ${price:.2f}.")

elif is_military == "yes":
